...
<title>Notion Admin - Unverified Users</title>
									...
									<div class="box-body">
										<div class="table-responsive">
											<table id="example1"
												...
												<tbody>
													<c:forEach items="${unverifiedUsersLs}" var="i">
														<tr>
															<td>${i.loginVO.username}</td>
															<td>${i.firstname} ${i.lastname}</td>
															<td><a href="userVerification?username=${i.loginVO.username}&firstname=${i.firstname}"><input type="button" class="btn btn-primary" value="Send Link"/></a></td>
														</tr>
													</c:forEach>
												</tbody>
												<tfoot>
