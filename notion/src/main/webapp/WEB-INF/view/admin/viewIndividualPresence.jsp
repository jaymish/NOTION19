...
<title>Notion Admin - Individual Events Presence</title>
							...
							<div class="col-12">
								<div class="box">
									<div class="box-header">
										<h4 class="box-title">List of Present Users</h4>
									</div>
									<div class="box-body">
