										...
										<div class="row">
											<div class="col-12">
												...
												<div class="form-group">
													...
													<div class="controls">
														<form:input type="number" name="teammin" path="teamMin" class="form-control"
															required="required"
															data-validation-required-message="This field is required"/>
													</div>
													...
													<div class="controls">
														<form:input type="number" name="teammax" path="teamMax" class="form-control"
															required="required"
															data-validation-required-message="This field is required"/>
													</div>
												</div>
